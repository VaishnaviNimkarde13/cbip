...
const FormContent = ({ tab }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography sx={{ fontSize: "13px", fontWeight: 600, lineHeight: 1.7 }}>
          Central Board of Irrigation &amp; Power (CBIP) has been successfully
          conducting technical audits of various{" "}
          {tab === "hydro"
            ? "hydro power stations"
            : tab === "water"
            ? "water resources projects"
            : "power sector projects"}{" "}
          of renowned organizations like NHPC, BBMB, SJVNL, UJVNL, JSW etc.
          through a panel of experts on{" "}
          {tab === "hydro"
            ? "Hydro Power"
            : tab === "water"
            ? "Water Resources"
            : "Power Sector"}
          . CBIP intends to empanel suitable experts in this area of expertise.
          Therefore, CBIP invites willingness from technical experts of good
          health who wish to associate with CBIP for conducting
          Safety/Technical audits of{" "}
          {tab === "hydro"
            ? "hydro power stations"
            : tab === "water"
            ? "water resources projects"
            : "power sector projects"}{" "}
          on an honorarium basis. Willing Experts are requested to kindly submit
          the below form duly filled.
        </Typography>
      </Box>
      ...
      <Box sx={{ px: 2, mb: 3 }}>
        ...
        <Box sx={{ display: "flex", gap: 2, mb: 2, flexWrap: { xs: "wrap", sm: "nowrap" } }}>
          <TextField
            ...
            onChange={(e) =>
              handleFieldChange("dateOfRetirement", e.target.value)
            }
            InputLabelProps={{ shrink: true }}
          />
          <TextField
            ...
            onChange={(e) =>
              handleFieldChange("seriousHealthCondition", e.target.value)
            }
          />
        </Box>
        ...
        <Box sx={{ mb: 2 }}>
          ...
          <RadioGroup
            ...
            onChange={(e) =>
              handleFieldChange("willingToTravel", e.target.value)
            }
          >
      ...
      <Box sx={{ px: 2, mb: 3 }}>
        <SectionHeader>
          Work Experience (Last 15 years only in reverse chronology)
        </SectionHeader>
        {workExp.map((row, i) => (
          <WorkExpRow
            key={i}
      ...
      <Box sx={{ px: 2, mb: 3 }}>
        <SectionHeader>
          Choose from the following areas your areas of expertise
        </SectionHeader>
        <Paper variant="outlined" sx={{ overflow: "hidden" }}>
          <Table size="small">
            <TableHead>
              <TableRow sx={{ background: "#d6eaf8" }}>
            ...
            <TableBody>
              {expertiseItems.map((item, i) => (
                ...
                >
                  <TableCell sx={{ fontSize: "13px", verticalAlign: "top", pt: 1.5 }}>
                    {i + 1}
                  </TableCell>
                  <TableCell>
