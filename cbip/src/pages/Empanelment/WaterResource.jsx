...
const subDisciplinesMap = {
  ...
  "Hydro Power Generation": [
    "Run-of-River Plants",
    "Storage Based Plants",
    "Pumped Storage Plants",
    "Small Hydro",
    "Micro Hydro",
    "Turbine & Auxiliaries",
    "Governor Systems",
    "Dam & Civil Structures",
  ],
  Transmission: [
...
const TabButton = ({ label, active, onClick }) => (
  <button
    ...
    style={{
      ...
      borderRadius: "4px",
      cursor: "pointer",
      border: active ? "2px solid #c0392b" : "2px solid #1a5276",
      background: active ? "#c0392b" : "#1a5276",
      color: "#fff",
      marginRight: "8px",
      transition: "all 0.2s",
    }}
...
const WaterResources = () => {
  ...
  const wordCount = briefProfile.trim()
    ? briefProfile.trim().split(/\s+/).length
    : 0;
  ...
  const handleMainDisciplineClick = (discipline) => {
    if (selectedMains.includes(discipline)) {
      ...
      if (activeDisciplineForSub === discipline)
  ...
  const handleOK = () => {
    ...
    const existing = confirmedSelections.filter(
      (s) => s.discipline !== activeDisciplineForSub
    );
    const newEntries = pendingSubDisciplines.map((sub) => ({
      discipline: activeDisciplineForSub,
      sub,
    }));
  ...
  const currentSubs = activeDisciplineForSub
    ? subDisciplinesMap[activeDisciplineForSub] || []
    : [];
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "center", fontSize: "13px", lineHeight: "1.6" }}>
              <strong>Central Board of</strong>
              <br />
              <strong>Irrigation &amp; Power</strong>
              <br />
              ...
              Phone no:
              <br />
              01126115984,26116567,24102437
              <br />
              E-mail:{" "}
              <a href="mailto:cbip@cbip.org" style={{ color: "#1565c0" }}>
                cbip@cbip.org
              </a>
              <br />
              Website:{" "}
              <a href="https://www.cbip.org" style={{ color: "#1565c0" }}>
                www.cbip.org
              </a>
            </div>
          ...
          <div style={{ padding: "20px 24px" }}>
            ...
            <FieldBox label="Personal Information">
              ...
              >
                <Input
                  placeholder="Name of the Expert/Specialist* *"
                  value={name}
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: "11px", color: "#666", textAlign: "right" }}>
                    {wordCount}/200 words Max. 200 words
                  </div>
                </div>
              </div>
            </FieldBox>
            ...
            <FieldBox label="Areas of Expertise">
              ...
              {/* Click One by One & Press OK */}
              <div style={{ marginTop: "12px" }}>
                <a
                  href="#"
                  style={{ fontSize: "13px", color: "#1565c0", marginRight: "12px" }}
                  onClick={(e) => {
                    e.preventDefault();
                  }}
                >
            ...
            <FieldBox label="Experience and Affiliations">
              ...
              >
                ...
                />
                <Textarea
                  placeholder="Affiliations/Certifications"
                  value={affiliations}
            ...
            <FieldBox label="Major Contributions">
              <Textarea
                placeholder="Major Projects/Contributions *"
                value={majorContributions}
                onChange={(e) => setMajorContributions(e.target.value)}
                rows={3}
              />
            </FieldBox>
